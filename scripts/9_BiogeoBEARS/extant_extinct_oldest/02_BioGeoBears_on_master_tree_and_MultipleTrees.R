...
############################################################
#wd = "/D:/liushuiyin/20211110_hybridization/20230511投稿三稿/20230605RevisedV1/Newanalyses_with_fossils/02.BiogeoBEARS/"
#setwd(wd)

trfn = "mcc_FBD_agerange_9c6m6_1b1.7combined.newick"
geogfn = "speciesrange_singleFossil.data"
...
library(cladoRcpp)
numstates_from_numareas(numareas=7, maxareas=3, include_null_range=TRUE)
############################################################
